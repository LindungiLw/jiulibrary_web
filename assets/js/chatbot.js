document.addEventListener('DOMContentLoaded', () => {
    ...
    const botResponses = {
        ...
        en: {
            ...
            "thesis":        BUDDY + "Printed theses can be submitted to the library. For <b>PDF soft files</b>, upload them according to the format guidelines via the link in our Instagram bio.",
